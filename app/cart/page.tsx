...
export default function CartPage() {
  ...
  useEffect(() => {
    // Load cart from localStorage (simplified - in production, use proper cart API)
              ...
              <div className="grid lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-4">
                  {cartItems.map((item) => (
                    <motion.div
                      ...
                      className="bg-white rounded-lg p-6 border border-stone shadow-sm"
                    >
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-lg font-bold text-deep-charcoal mb-4">
                          ...
                          <div className="flex items-center gap-4">
                            <div className="flex items-center gap-2 border border-stone rounded-lg">
                              <button
                                ...
                                className="p-2 hover:bg-soft-beige transition-colors"
                              >
                ...
                <div className="lg:col-span-1">
                  <div className="bg-white rounded-lg p-6 border border-stone shadow-sm sticky top-24">
                    ...
                    <Link
                      href="/checkout"
                      className="block w-full bg-champagne-gold text-soft-black text-center px-8 py-3 rounded-lg font-semibold hover:bg-warm-gold transition-all"
                    >
                      Proceed to Checkout
                    </Link>
                    <Link
                      href="/catalog"
                      className="block w-full text-center mt-4 text-taupe hover:text-deep-charcoal transition-colors"
                    >
                      Continue Shopping
                    </Link>
                  </div>
