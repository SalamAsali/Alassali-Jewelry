...
const landingContent: Record<string, {
  ...
  'engagement-rings': {
    ...
    faq: [
      ...
      { q: 'Which diamond shape is best for me?', a: 'Round brilliant is the most popular for its fire, oval and pear look larger per carat, princess and emerald cuts suit modern tastes, and cushion and radiant offer vintage warmth. During your consultation we walk through every shape and, where helpful, ship preview stones or renders so you can compare before committing.' },
      ...
      { q: 'Where are you based?', a: 'We are a Toronto-based bespoke atelier — appointment only, no walk-in storefront. Consultations run virtually by default and finished pieces ship insured across the GTA, with private in-person sessions in Toronto available on request.' },
    ],
    relatedPages: [
  ...
  'rings': {
    ...
    faq: [
      ...
      { q: 'How do I determine my ring size?', a: 'We ship a free ring sizer kit to your door, or walk you through measuring with a printable sizer or string. A precise in-person sizing by appointment in Toronto is available when preferred. Every custom ring also includes free resizing.' },
  ...
  'pendants': {
    ...
    faq: [
      ...
      { q: 'How do I receive my finished pendant?', a: 'Complimentary insured delivery anywhere in the GTA — or a private in-person handover in Toronto by appointment if you prefer. We also ship securely anywhere in Canada.' },
    ],
    relatedPages: [
      { name: 'Custom Chains', path: '/custom/chains' },
      { name: 'Custom Rings', path: '/custom/rings' },
  ...
  'bracelets': {
    ...
    faq: [
      ...
      { q: 'How do I measure my wrist for a bracelet?', a: 'Wrap a flexible tape measure snugly around your wrist just below the wrist bone, then add 0.5" (loose) or 0.25" (snug). Standard men\'s: 7.5-8.5". Standard women\'s: 6.5-7". A precise in-person measurement by appointment in Toronto is available if preferred.' },
  ...
  'grillz': {
    ...
    processNote: 'Custom grillz take 1-2 weeks after your mold appointment. We take a precise dental impression, design your grillz, and handcraft them in your chosen metal and stone configuration. Mold sessions are by appointment only — book a time in Toronto or request a mail-in mold kit for out-of-area clients.',
    ...
    faq: [
      ...
      { q: 'VVS vs VS vs SI — which clarity should I pick for grillz?', a: 'VVS offers the cleanest, brightest look and is our premium tier. VS gives a near-identical visual face-up for about 20-30% less. SI stones look great in micro-pavé or dust settings. We walk through all three during your consultation with high-res photography of loose stones.' },
      ...
      { q: 'How does the grillz mold process work?', a: 'We take a precise dental-grade silicone impression of your teeth at a private in-person mold session in Toronto (book by appointment) — or we can ship you a mail-in mold kit with step-by-step instructions for out-of-area clients. The impression is cast into a stone model that we use to shape and fit your grillz exactly to your bite. The in-person session takes about 20 minutes.' },
...
const hubProcessSteps = [
  { icon: MessageSquare, title: 'Consultation', body: 'Free virtual consultation (Zoom or phone) to understand your vision, budget, and timeline. Private in-person sessions available by appointment.' },
...
const hubFaq = [
  { q: 'Where is Al-Assali Jewelry based?', a: 'We are a Toronto-based bespoke atelier. There is no walk-in storefront — we operate by appointment only, running consultations virtually by default with private in-person sessions in Toronto available on request.' },
  { q: 'Do I need an appointment to work with you?', a: 'Yes — we work by appointment only. Book a free virtual consultation by phone, email, or through our custom inquiry form and we\'ll confirm a time that works for you.' },
  { q: 'What areas around Toronto do you serve?', a: 'We are based in Toronto and regularly work with clients from across the Greater Toronto Area including Mississauga, Etobicoke, North York, Scarborough, Vaughan, Markham, Oakville, Burlington, Brampton, and Milton — with complimentary insured delivery anywhere in the GTA.' },
  { q: 'How do I start a custom jewellery project?', a: 'Book a free virtual consultation. We\'ll discuss your vision, budget, and timeline, then produce CAD renderings for your approval before any crafting begins. Most projects take 2-6 weeks from design approval.' },
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28 space-y-20">
        ...
        <header className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-stone leading-relaxed text-base md:text-lg">
            Al-Assali Jewelry is a Toronto-based bespoke jewellery atelier. Master jeweller Mohammad Al-Assali and our team design and handcraft every custom engagement ring, wedding band, diamond pendant, gold chain, and grillz set entirely in-house in Toronto — no outsourcing, no middlemen. From the first consultation to the final polish, every piece is crafted under one roof with a lifetime craftsmanship guarantee.
          </p>
        </header>
        ...
        <div className="bg-charcoal/40 border border-glacier-grey/20 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: MapPin, title: 'Made in Toronto', body: 'Designed, cast, set, and finished entirely in-house in our Toronto workshop.' },
        ...
        <div className="bg-charcoal/30 border border-glacier-grey/20 rounded-2xl p-8 md:p-12 text-center max-w-3xl mx-auto">
          ...
          <p className="text-stone leading-relaxed text-sm md:text-base">
            Mohammad is the founder and master jeweller behind Al-Assali Jewelry. A George Brown College Jewellery Arts Program graduate practicing since 2017, he has designed and handcrafted hundreds of bespoke engagement rings, gold chains, diamond pendants, and custom grillz for clients across the Greater Toronto Area. Every piece that leaves our Toronto workshop has been personally inspected and finished by Mohammad.
          </p>
        </div>
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-stone leading-relaxed text-sm mb-6">
            Al-Assali Jewelry is a Toronto-based bespoke atelier working by appointment only. Most projects run virtually — free Zoom or phone consultations, CAD renders shared remotely, and the finished piece delivered insured anywhere in the GTA. Private in-person sessions in Toronto can be booked when a project calls for one.
          </p>
