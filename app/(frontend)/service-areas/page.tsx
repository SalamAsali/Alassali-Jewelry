      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28 space-y-20">
        ...
        <header className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-stone leading-relaxed mb-6">
            Al-Assali Jewelry is a Toronto-based bespoke atelier — appointment only. We craft custom engagement rings, wedding bands, gold chains, diamond pendants, and custom grillz for clients across Toronto and the wider Greater Toronto Area, with free virtual consultations, complimentary insured delivery across the GTA, and private in-person sessions available on request.
          </p>
        </header>
