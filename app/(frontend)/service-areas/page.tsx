      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28 space-y-20">
        ...
        <header className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-stone leading-relaxed mb-6">
            Al-Asali Jewelry Studio is a Toronto-based bespoke custom jeweler. We craft custom engagement rings, wedding bands, gold chains, diamond pendants, and custom grillz for clients across Toronto and the wider Greater Toronto Area — by appointment, with free virtual consultations, complimentary secure insured delivery, and optional in-person meetings in Toronto.
          </p>
        </header>
