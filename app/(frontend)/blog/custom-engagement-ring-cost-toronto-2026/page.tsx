...
export default function Page() {
  ...
  return (
    <BlogLayout
      title={TITLE}
      subtitle="A transparent look at what actually shapes your price: style, metal, diamond origin, and carat weight."
      datePublished={DATE}
      readingMinutes={7}
    ...
    >
      ...
      <ul>
        ...
        <li><strong>14K Gold:</strong> 58.3% pure; our most popular choice, a strong balance of purity, colour, and value</li>
        ...
        <li><strong>Platinum:</strong> 95% pure platinum; rarest, heaviest, hypoallergenic, naturally white and prestige-tier, and also the highest price point</li>
      </ul>
      <p>
      ...
      <ul>
        <li>Free consultation (virtual via Zoom, phone, or message, or in-person in Toronto by appointment)</li>
      ...
      <p>
        Our standard timeline is 4–6 weeks from design approval. Simpler solitaires can be completed in 3–4 weeks; three-stone and heavily pavé designs take 5–6. Rush orders can be accommodated for an additional fee, which helps when you&apos;ve already chosen a proposal date.
      </p>

      <h2>Why our prices are competitive</h2>
      <p>
        We craft every ring in-house in Toronto, with no outsourcing, no middlemen, and no broker markup. That means your dollars go into the stone and the craftsmanship, not into intermediaries. We also quote line-by-line so you can see exactly where your money is going.
      </p>
