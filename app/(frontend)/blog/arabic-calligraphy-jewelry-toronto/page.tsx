...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${SITE_CONFIG.url}/blog/arabic-calligraphy-jewelry-toronto` },
  openGraph: { title: TITLE, description: DESCRIPTION, type: 'article', images: [COVER], url: `${SITE_CONFIG.url}/blog/arabic-calligraphy-jewelry-toronto`, locale: 'en_CA', siteName: 'Al-Asali Jewelry' },
}
...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <p>
        The Throne Verse is one of the most beloved verses of the Quran, often worn for protection. These pendants require careful proofreading of every character; we reference authoritative sources for the script before any CAD work begins. Oval or rectangular silhouettes are most popular. Because of the letter density and detailed setting work involved, these pieces are among our more complex commissions.
      </p>
      <h3>Name pendants</h3>
      <p>
      ...
      <p>
        One of our most meaningful categories. Clients send us a handwritten phrase, from a parent, a grandparent, or a loved one who has passed, and we render it in gold. The asymmetry and texture of real handwriting translates beautifully into jewelry.
      </p>
