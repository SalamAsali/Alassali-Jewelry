...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <p>
        Whether you have a specific verse in mind, a family member&apos;s handwriting you want preserved in gold, or just an idea — we&apos;ll walk you through it. Consultations are free and virtual by default, with private in-person sessions in Toronto available by appointment.
      </p>
