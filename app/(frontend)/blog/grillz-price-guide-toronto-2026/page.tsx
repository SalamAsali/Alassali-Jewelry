...
export default function Page() {
  ...
  return (
    ...
    >
      ...
      <h2>The range is wide, and here&apos;s why</h2>
      <p>
      ...
      <p>
        VS (Very Slightly Included) diamonds have small inclusions visible only under 10× magnification, so they are eye-clean face-up. VVS (Very, Very Slightly Included) have inclusions so tiny most jewelers struggle to find them under a loupe, and noticeably brighter in direct light.
      </p>
      <p>
      ...
      <p>
        Book by phone or through our custom inquiry form. Free consultation, and we&apos;ll walk through all options and pricing virtually, and once you&apos;re ready we book a mold session in Toronto to take the impression in person.
      </p>
