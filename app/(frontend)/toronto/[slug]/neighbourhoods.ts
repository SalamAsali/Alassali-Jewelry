...
export const neighbourhoods: Record<string, Neighbourhood> = {
  'oakwood-vaughan': {
    ...
    h1: 'Custom Jeweler Serving Oakwood–Vaughan, Toronto',
    metaTitle: 'Custom Jeweler Oakwood–Vaughan Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving Oakwood–Vaughan by appointment. Engagement rings, chains, grillz, pendants — all handcrafted in-house.',
    hook: 'A Toronto bespoke jeweler serving Oakwood–Vaughan by appointment.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke custom jeweler serving clients in Oakwood–Vaughan. Every engagement ring, wedding band, gold chain, diamond pendant, and custom grillz we craft is designed, cast, set, and finished in-house in Toronto — never outsourced overseas. We work with Oakwood–Vaughan clients by virtual consultation, secure insured delivery, and by-appointment in-person meetings.',
    aboutArea: 'Oakwood–Vaughan is one of Toronto\'s most diverse and creative neighbourhoods, stretching along Vaughan Rd between St Clair Ave W and Eglinton Ave W. The area has a long tradition of independent jewelers, designers, and family-run shops. We\'re proud to continue that tradition with a modern bespoke practice rooted in the community.',
    whyLocal: [
  ...
  'yorkville': {
    slug: 'yorkville',
    name: 'Yorkville',
    h1: 'Custom Jeweler Serving Yorkville, Toronto',
    metaTitle: 'Custom Jeweler Yorkville Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Yorkville by appointment. Engagement rings, wedding bands, diamond pendants, grillz — handcrafted in-house with transparent pricing.',
    hook: 'Yorkville clients choose us for bespoke work without the Mink Mile markup.',
    intro: 'Yorkville is Toronto\'s luxury shopping district — but luxury shouldn\'t mean overpaying. Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving Yorkville clients by appointment, offering the same caliber of engagement rings, wedding bands, and diamond pieces you\'d find in Mink Mile windows — with transparent pricing and in-house craftsmanship, and no broker markup.',
    aboutArea: 'Yorkville — bounded roughly by Avenue Rd, Bloor St W, Yonge St, and Davenport Rd — is one of North America\'s most recognized luxury retail destinations. Mink Mile hosts Tiffany, Cartier, Birks, Harry Winston, Louis Vuitton, and Chanel. It\'s a natural home for engagement ring shopping — and a natural fit for Al-Asali clients who want custom craftsmanship at a better price.',
    whyLocal: [
      'Free virtual consultations via Zoom, phone, or message',
    ...
    faq: [
      ...
      { q: 'How do your prices compare to Yorkville luxury jewelers?', a: 'Typically 30–50% less for comparable quality. Mink Mile prices include significant brand premium — we quote line-by-line (diamond, metal, setting labour) with no brand markup.' },
  ...
  'north-york': {
    slug: 'north-york',
    name: 'North York',
    h1: 'Custom Jeweler Serving North York, Toronto',
    metaTitle: 'Custom Jeweler North York Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving North York by appointment. Custom engagement rings, gold chains, diamond pendants, grillz — handcrafted in-house.',
    hook: 'North York clients make up a big share of our custom orders — here\'s why.',
    intro: 'North York is one of Toronto\'s largest communities and home to a significant portion of our client base. From custom engagement rings in Willowdale to gold chains in Downsview, Al-Asali Jewelry Studio handles bespoke work for North York clients every week — entirely by virtual consultation, with secure insured delivery, and optional in-person appointments in Toronto.',
  ...
  'etobicoke': {
    slug: 'etobicoke',
    name: 'Etobicoke',
    h1: 'Custom Jeweler Serving Etobicoke, Toronto',
    metaTitle: 'Custom Jeweler Etobicoke Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Etobicoke by appointment. Custom engagement rings, gold chains, diamond pendants, grillz — handcrafted in-house.',
    hook: 'Etobicoke clients get handcrafted Toronto quality without the retail markup.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving clients across Etobicoke\'s diverse neighbourhoods — from The Queensway and Mimico to Humber Bay, Kingsway, and Rexdale. We work with Etobicoke clients by free virtual consultation, with secure insured delivery of finished pieces and optional in-person appointments in Toronto.',
  ...
  'scarborough': {
    slug: 'scarborough',
    name: 'Scarborough',
    h1: 'Custom Jeweler Serving Scarborough, Toronto',
    metaTitle: 'Custom Jeweler Scarborough Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Scarborough by appointment. Custom engagement rings, gold chains, diamond pendants, grillz — handcrafted in-house.',
  ...
  'wychwood': {
    slug: 'wychwood',
    name: 'Wychwood',
    h1: 'Custom Jeweler Serving Wychwood, Toronto',
    metaTitle: 'Custom Jeweler Wychwood Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Wychwood by appointment. Engagement rings, wedding bands, chains, grillz handcrafted in-house — virtual consultations and secure delivery.',
    hook: 'Wychwood clients choose us for bespoke engagement rings, wedding bands, and heirloom resets.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving Wychwood clients by appointment. Wychwood residents come to us for custom engagement rings, wedding bands, and heirloom ring resets — with free virtual consultations, complimentary secure insured delivery, and optional in-person meetings in Toronto when preferred.',
  ...
  'forest-hill': {
    slug: 'forest-hill',
    name: 'Forest Hill',
    h1: 'Custom Jeweler Serving Forest Hill, Toronto',
    metaTitle: 'Custom Jeweler Forest Hill Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Forest Hill by appointment. Engagement rings, wedding bands, diamond pendants, and heirloom resets handcrafted in-house.',
    hook: 'Forest Hill clients choose us for heirloom resets, milestone pieces, and discreet luxury work.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving Forest Hill clients by private appointment. Forest Hill families come to us for milestone engagement rings, heirloom diamond resets, anniversary bands, and discreet private commissions — with free virtual consultations, secure insured delivery, and by-appointment in-person meetings in Toronto.',
  ...
  'bathurst-st-clair': {
    ...
    h1: 'Custom Jeweler Serving the Bathurst–St Clair Corridor',
    metaTitle: 'Custom Jeweler Bathurst & St Clair Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving the Bathurst–St Clair corridor by appointment. Engagement rings, chains, grillz, pendants all handcrafted in-house.',
    hook: 'A Toronto bespoke jeweler serving the Bathurst–St Clair corridor by appointment.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving the Bathurst–St Clair corridor. We craft custom engagement rings, wedding bands, gold chains, and grillz for neighbours across the corridor — by free virtual consultation, complimentary secure insured delivery, and optional in-person meetings in Toronto by appointment.',
