...
export const neighbourhoods: Record<string, Neighbourhood> = {
  'oakwood-vaughan': {
    ...
    metaTitle: 'Custom Jeweler Oakwood–Vaughan Toronto',
    metaDescription: 'Bespoke Toronto custom jeweler serving Oakwood–Vaughan by appointment. Engagement rings, chains, grillz, and pendants handcrafted in-house.',
  ...
  'yorkville': {
    ...
    metaTitle: 'Custom Jeweler Yorkville Toronto',
    metaDescription: 'Bespoke Toronto custom jeweler serving Yorkville by appointment. Engagement rings, wedding bands, diamond pendants, and grillz handcrafted in-house.',
  ...
  'north-york': {
    ...
    metaTitle: 'Custom Jeweler North York Toronto',
  ...
  'etobicoke': {
    ...
    metaTitle: 'Custom Jeweler Etobicoke Toronto',
  ...
  'scarborough': {
    ...
    metaTitle: 'Custom Jeweler Scarborough Toronto',
  ...
  'wychwood': {
    ...
    metaTitle: 'Custom Jeweler Wychwood Toronto',
    metaDescription: 'Bespoke Toronto custom jeweler serving Wychwood by appointment. Engagement rings, wedding bands, chains, and grillz handcrafted in-house.',
  ...
  'forest-hill': {
    ...
    metaTitle: 'Custom Jeweler Forest Hill Toronto',
  ...
  'bathurst-st-clair': {
    ...
    metaTitle: 'Custom Jeweler Bathurst & St Clair Toronto',
