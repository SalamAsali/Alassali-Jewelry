...
export const neighbourhoods: Record<string, Neighbourhood> = {
  'oakwood-vaughan': {
    ...
    metaTitle: 'Custom Jeweller Oakwood–Vaughan Toronto | Al-Asali Jewelry Studio',
    metaDescription: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweller serving Oakwood–Vaughan by appointment. Engagement rings, chains, grillz, pendants — all handcrafted in-house.',
    hook: 'A Toronto bespoke jeweller serving Oakwood–Vaughan by appointment.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke custom jeweller serving clients in Oakwood–Vaughan. Every engagement ring, wedding band, gold chain, diamond pendant, and custom grillz we craft is designed, cast, set, and finished in-house in Toronto — never outsourced overseas. We work with Oakwood–Vaughan clients by virtual consultation, secure insured delivery, and by-appointment in-person meetings.',
  ...
  'yorkville': {
    ...
    metaTitle: 'Custom Jeweller Yorkville Toronto | Al-Asali Jewelry Studio',
    ...
    intro: 'Yorkville is Toronto\'s luxury shopping district — but luxury shouldn\'t mean overpaying. Al-Asali Jewelry Studio is a Toronto-based bespoke jeweller serving Yorkville clients by appointment, offering the same caliber of engagement rings, wedding bands, and diamond pieces you\'d find in Mink Mile windows — with transparent pricing and in-house craftsmanship, and no broker markup.',
  ...
  'north-york': {
    ...
    metaTitle: 'Custom Jeweller North York Toronto | Al-Asali Jewelry Studio',
  ...
  'etobicoke': {
    ...
    metaTitle: 'Custom Jeweller Etobicoke Toronto | Al-Asali Jewelry Studio',
  ...
  'scarborough': {
    ...
    metaTitle: 'Custom Jeweller Scarborough Toronto | Al-Asali Jewelry Studio',
  ...
  'wychwood': {
    ...
    metaTitle: 'Custom Jeweller Wychwood Toronto | Al-Asali Jewelry Studio',
  ...
  'forest-hill': {
    ...
    metaTitle: 'Custom Jeweller Forest Hill Toronto | Al-Asali Jewelry Studio',
  ...
  'bathurst-st-clair': {
    ...
    metaTitle: 'Custom Jeweller Bathurst & St Clair Toronto | Al-Asali Jewelry Studio',
    ...
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweller serving the Bathurst–St Clair corridor. We craft custom engagement rings, wedding bands, gold chains, and grillz for neighbours across the corridor — by free virtual consultation, complimentary secure insured delivery, and optional in-person meetings in Toronto by appointment.',
