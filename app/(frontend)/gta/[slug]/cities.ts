...
export const gtaCities: Record<string, GtaCity> = {
  'mississauga': {
    ...
    metaTitle: 'Custom Jeweller Mississauga | Al-Asali Jewelry Studio',
  ...
  'vaughan': {
    ...
    metaTitle: 'Custom Jeweller Vaughan | Al-Asali Jewelry Studio',
  ...
  'markham': {
    ...
    metaTitle: 'Custom Jeweller Markham | Al-Asali Jewelry Studio',
