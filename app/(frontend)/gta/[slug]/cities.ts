...
export const gtaCities: Record<string, GtaCity> = {
  'mississauga': {
    slug: 'mississauga',
    name: 'Mississauga',
    h1: 'Custom Jeweler Serving Mississauga',
    metaTitle: 'Custom Jeweler Mississauga | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Mississauga by appointment. Custom engagement rings, gold chains, diamond pendants, grillz — handcrafted in-house, no outsourcing.',
    hook: 'Mississauga clients make up one of our largest GTA bases.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke custom jeweler that regularly serves clients from across Mississauga — from Port Credit and Clarkson in the south to Meadowvale, Streetsville, and Malton in the north. Every piece is designed and handcrafted in-house in Toronto, then delivered fully insured to your door anywhere in Mississauga.',
  ...
  'vaughan': {
    slug: 'vaughan',
    name: 'Vaughan',
    h1: 'Custom Jeweler Serving Vaughan',
    metaTitle: 'Custom Jeweler Vaughan | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Vaughan and Woodbridge by appointment. Custom engagement rings, gold chains, diamond pendants, grillz — handcrafted in-house.',
    hook: 'Woodbridge, Thornhill, and Maple clients choose us for in-house craftsmanship and transparent pricing.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving Vaughan clients by appointment. Woodbridge, Thornhill, Maple, Concord, and Kleinburg clients make up a significant part of our custom engagement ring and wedding band bookings, drawn by in-house craftsmanship, transparent pricing, and deep Arabic calligraphy expertise.',
  ...
  'markham': {
    slug: 'markham',
    name: 'Markham',
    h1: 'Custom Jeweler Serving Markham',
    metaTitle: 'Custom Jeweler Markham | Al-Asali Jewelry Studio',
    metaDescription: 'Bespoke Toronto custom jeweler serving Markham, Unionville, and Thornhill by appointment. Custom engagement rings, gold chains, diamond pendants, grillz.',
    hook: 'Markham clients bring us some of our most intricate custom design briefs.',
    intro: 'Al-Asali Jewelry Studio is a Toronto-based bespoke jeweler serving Markham clients by appointment. Unionville, Thornhill, Milliken, and Cornell clients come to us for bespoke engagement rings, custom heritage pendants, tennis bracelets, and solid gold chains — always crafted in-house with GIA-graded diamonds.',
