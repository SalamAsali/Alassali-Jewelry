...
export const gtaCities: Record<string, GtaCity> = {
  'mississauga': {
    ...
    metaTitle: 'Custom Jeweler Mississauga',
    metaDescription: 'Bespoke Toronto custom jeweler serving Mississauga by appointment. Custom engagement rings, gold chains, diamond pendants, and grillz handcrafted in-house.',
  ...
  'vaughan': {
    ...
    metaTitle: 'Custom Jeweler Vaughan',
    metaDescription: 'Bespoke Toronto custom jeweler serving Vaughan and Woodbridge by appointment. Custom engagement rings, gold chains, diamond pendants, and grillz handcrafted in-house.',
  ...
  'markham': {
    ...
    metaTitle: 'Custom Jeweler Markham',
