      ...
      <div className="section-container">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link href="/catalog" className="inline-block bg-glacier-grey text-white px-8 py-3 rounded-lg font-semibold hover:bg-glacier-grey-light transition-all">Browse Collection</Link>
          </div>
        ) : (
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg p-6 border border-stone shadow-sm sticky top-24">
                ...
                <Link href="/checkout" className="block w-full bg-glacier-grey text-white text-center px-8 py-3 rounded-lg font-semibold hover:bg-glacier-grey-light transition-all">Proceed to Checkout</Link>
