    ...
    <div className="bg-off-white py-24">
      <div className="section-container max-w-2xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/cart" className="bg-glacier-grey text-white px-8 py-3 rounded-lg font-semibold hover:bg-glacier-grey-light transition-all">Return to Cart</Link>
          <Link href="/chains" className="bg-white border-2 border-deep-charcoal text-deep-charcoal px-8 py-3 rounded-lg font-semibold hover:bg-deep-charcoal hover:text-white transition-all">Continue Shopping</Link>
        </div>
      </div>
    </div>
  )
