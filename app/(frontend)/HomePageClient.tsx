    ...
    <div className="overflow-hidden bg-white">
          ...
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="relative">
            ...
            <div className="block lg:hidden text-center py-12">
              ...
              <div className="grid grid-cols-2 gap-4 max-w-lg mx-auto">
                ...
                <motion.img initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} src={img2} alt="Custom chain design crafted in Toronto" className="w-full aspect-[3/4] object-cover object-[30%_center] rounded-lg shadow-2xl border-2 border-glacier-grey/50" />
              </div>
            ...
            <div className="hidden lg:block relative px-12 pb-36">
              ...
              <div className="flex items-center justify-center relative">
                ...
                <div className="relative inline-block">
                  ...
                  <motion.img initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} src={img2} alt="Custom gold chain - Toronto artistry" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-64 xl:w-56 xl:h-72 2xl:w-64 2xl:h-80 object-cover object-[30%_center] rounded-lg shadow-2xl border-4 border-glacier-grey/50" style={{ zIndex: 10 }} />
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="relative bg-soft-black text-white py-24" data-testid="final-cta-section">
        ...
        <div className="section-container text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white" style={{ fontFamily: 'var(--font-heading)' }}>Start Your Custom Jewelry Design<br /><span className="text-glacier-grey">in Toronto</span></h2>
