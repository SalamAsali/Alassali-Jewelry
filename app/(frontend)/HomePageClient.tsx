            ...
            <div className="hidden lg:block relative px-12 pb-36">
              ...
              <div className="flex items-center justify-center relative">
                ...
                <div className="relative inline-block">
                  ...
                  <motion.img initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} src={img2} alt="Custom gold chain - Toronto artistry" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 -rotate-45 w-48 h-64 xl:w-56 xl:h-72 2xl:w-64 2xl:h-80 object-cover rounded-lg shadow-2xl border-4 border-glacier-grey/50" style={{ zIndex: 10 }} />
                </div>
              </div>
            </div>
          </motion.div>
