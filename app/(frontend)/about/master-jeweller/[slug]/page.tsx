...
export const metadata: Metadata = {
  title: 'Mohammad Al-Assali — Master Jeweller & Founder | Al-Assali Jewelry Toronto',
  description: 'Meet Mohammad Al-Assali — master jeweller and founder of Al-Assali Jewelry Studio in Toronto. George Brown College Jewellery Arts graduate, practicing since 2017.',
  alternates: { canonical: `/about/master-jeweller/${MASTER_JEWELLER.slug}` },
}

export default function MasterJewellerPage() {
  const breadcrumb = buildBreadcrumbSchema([
    { name: 'Home', url: SITE_CONFIG.url },
    { name: 'About', url: `${SITE_CONFIG.url}/about/master-jeweller/${MASTER_JEWELLER.slug}` },
    { name: MASTER_JEWELLER.name, url: `${SITE_CONFIG.url}/about/master-jeweller/${MASTER_JEWELLER.slug}` },
  ])
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-20 md:py-28 space-y-20">
        ...
        <header className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 mb-5">
            ...
            <span className="text-xs uppercase tracking-widest text-glacier-grey font-medium">Master Jeweller &amp; Founder</span>
          </div>
          ...
          <p className="text-xl text-stone leading-relaxed">
            Toronto&apos;s bespoke jeweller behind every piece that leaves Al-Assali Jewelry Studio.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-charcoal/50 border border-glacier-grey/20 rounded-2xl p-8">
            ...
            <ul className="space-y-2 text-stone text-sm">
              <li>
                <span className="text-white font-medium">George Brown College</span><br />
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={title} className="bg-charcoal/50 border border-glacier-grey/20 rounded-xl p-5">
