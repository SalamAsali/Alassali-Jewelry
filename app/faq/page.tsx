    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Standard shipping within Canada takes 3-5 business days. International shipping varies by destination. Express shipping options are available for an additional fee.'
        },
        {
          id: 'shipping-3',
          question: 'Is shipping insured?',
          answer: 'Yes, all shipments are fully insured. We take every precaution to ensure your jewelry arrives safely and securely.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'Custom jewelry typically takes 4-8 weeks from design approval to completion. Complex pieces may take longer. We will provide a detailed timeline during your consultation.'
        },
        {
          id: 'custom-2',
          question: 'Can I see the design before production?',
          answer: 'Absolutely! We provide CAD renderings and detailed sketches before production begins. You can request revisions until you are completely satisfied with the design.'
        },
        {
          id: 'custom-3',
          question: 'What is your return policy for custom pieces?',
          answer: 'Custom pieces are made to your specifications and are non-returnable. However, we offer complimentary resizing and adjustments within 30 days of delivery.'
        }
      ]
    },
    {
      ...
      questions: [
        {
          ...
          answer: 'We provide detailed care instructions with every purchase. Generally, store jewelry in a soft pouch, avoid harsh chemicals, and clean with a soft cloth. Professional cleaning is recommended annually.'
        },
        {
          id: 'care-2',
          question: 'Do you offer resizing?',
          answer: 'Yes! We offer complimentary resizing within 30 days of purchase. After that, resizing is available for a small fee.'
        },
        {
          id: 'care-3',
          question: 'What is your warranty?',
          answer: 'All jewelry comes with a lifetime warranty against manufacturing defects. Normal wear and tear is not covered, but we offer repair services at reasonable rates.'
        }
      ]
    }
  ]
          ...
          <div className="section-container relative z-10">
            ...
            >
              ...
              <p className="text-lg text-stone max-w-3xl mx-auto">
                Everything you need to know about our jewelry, services, and policies
              </p>
            </motion.div>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    {category.questions.map((faq) => (
                      <div
                        key={faq.id}
                        className="bg-off-white rounded-lg border border-stone overflow-hidden"
                      >
                        <button
                        ...
                        >
                          ...
                          {expandedItems.includes(faq.id) ? (
                            <Minus className="w-5 h-5 text-champagne-gold flex-shrink-0" />
                          ) : (
                            <Plus className="w-5 h-5 text-champagne-gold flex-shrink-0" />
                          )}
                        </button>
                        <AnimatePresence>
                          {expandedItems.includes(faq.id) && (
                            ...
                            >
                              <div className="px-6 py-4 text-taupe leading-relaxed">
                                {faq.answer}
                              </div>
                            </motion.div>
                          )}
