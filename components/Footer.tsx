    ...
    <footer className="bg-deep-charcoal text-white">
      <div className="section-container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/about/master-jeweler/mohammad-al-asali" className="text-warm-gray hover:text-glacier-grey transition-colors">Master Jeweler</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-charcoal text-center text-warm-gray text-sm">
          <p>&copy; {new Date().getFullYear()} Al-Asali Jewelry. Crafted with precision in Toronto.</p>
        </div>
      </div>
    </footer>
  )
