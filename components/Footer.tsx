...
const DEFAULT_TAGLINE = `Custom jeweller in Toronto since ${SITE_CONFIG.founded}. Every piece designed, cast, set, and finished in-house in Toronto — by appointment, virtually or privately in-person.`
