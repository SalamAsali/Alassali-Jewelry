...
export default function Navigation(props?: NavigationProps) {
  ...
  const bespokeMenu = [
    ...
    { name: 'Wedding Bands', path: '/custom-wedding-bands-toronto', icon: '/images/icons/bridal-bands.svg' },
    { name: 'Rings', path: '/custom-rings-toronto', icon: '/images/icons/rings.svg' },
    { name: 'Pendants', path: '/custom-pendants-toronto', icon: '/images/icons/pendants.svg' },
    { name: 'Chains', path: '/custom-chains-toronto', icon: '/images/icons/chains.svg' },
  ...
  const menuItems = [
    ...
    { name: 'FAQ', path: '/faq' },
    // The 'Chains' item is the READY-MADE catalog entry (paused). With it
    // filtered out, the chains dropdown render blocks below can never open —
    // they stay in place, dormant, for when the catalog returns. The bespoke
    // 'Chains' entry in bespokeMenu above is unaffected.
  ].filter((item) => CHAIN_CATALOG_ENABLED || item.dropdownType !== 'chains')
