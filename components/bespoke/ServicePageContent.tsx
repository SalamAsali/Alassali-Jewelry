...
// ---------------------------------------------------------------------------
// Helper: replace "Ontario" references in a string with the city name
// ---------------------------------------------------------------------------

function localize(text: string, locationName: string): string {
  if (locationName === 'Ontario') return text
  return text
    .replace(/Ontario-based/g, `${locationName}-based`)
    .replace(/Ontario's/g, `${locationName}'s`)
    .replace(/Ontario\'s/g, `${locationName}'s`)
    .replace(/across Ontario/g, `in ${locationName} and surrounding areas`)
    .replace(/in Ontario/g, `in ${locationName}`)
    .replace(/\bOntario\b/g, locationName)
}

// ---------------------------------------------------------------------------
// SEO landing page content per type — with location-aware text
// ---------------------------------------------------------------------------

function getLandingContent(locationName: string): Record<string, {
  heroH1: string
  heroSub: string
  intro: string
  processNote: string
  ...
  return {
  'engagement-rings': {
    heroH1: `Custom Engagement Rings in ${L}`,
    heroSub: localize('Design a one-of-a-kind ring as unique as your love story — handcrafted in-house by Ontario\'s finest.', L),
    intro: localize('At Al-Asali Jewelry, every custom engagement ring begins with your vision. Whether you dream of a classic solitaire, a vintage halo setting, or a bold modern design, our master craftspeople bring it to life entirely in-house in Ontario. Choose from ethically sourced natural and lab-grown diamonds, sapphires, rubies, and emeralds — set in platinum, 18K, or 14K gold. From the first sketch to the final presentation, your engagement ring is crafted with the care and precision your moment deserves. Couples across Ontario trust us because we don\'t outsource — every cut, setting, and polish happens under our roof.', L),
    processNote: localize('Most custom engagement rings take 4-6 weeks from design approval to completion. We start with a personal consultation to understand your vision, create detailed CAD renderings for your approval, then hand-select your stones before our master jewelers begin crafting. Rush orders are available when your timeline demands it.', L),
    budgetGuide: localize('Custom engagement rings start at $1,000 and scale based on your choice of metal, stone type, carat weight, and design complexity. During consultation, we\'ll work within your budget to maximize brilliance — whether that means a stunning lab-grown diamond or a natural stone with exceptional cut quality.', L),
    stoneNote: localize('Choose from natural diamonds, lab-grown diamonds, sapphires, rubies, and emeralds. We source every stone for maximum fire and brilliance, and we\'re happy to walk you through the 4Cs (cut, clarity, colour, carat) during your consultation. Lab-grown diamonds offer the same physical properties at a lower price point.', L),
    faq: [
      { q: localize('How long does it take to make a custom engagement ring in Ontario?', L), a: localize('Most custom engagement rings take 4-6 weeks from design approval to completion. Rush orders can be completed in 2-3 weeks for an additional fee, and we\'ll keep you updated at every stage.', L) },
      { q: localize('How much does a custom engagement ring cost in Ontario?', L), a: localize('Custom engagement rings start at $1,000 and scale with metal choice, diamond origin (lab-grown or natural), carat weight, and design complexity. Solitaires start around $1,800, halo rings around $3,500, and three-stone designs from $4,500. We quote every project up front with no hidden fees.', L) },
      { q: localize('Can I design my own engagement ring?', L), a: localize('Absolutely. Bring us sketches, Pinterest boards, or just a rough idea — our designers will create detailed 3D CAD renderings for your approval before any crafting begins. You can iterate as many times as you need.', L) },
      { q: localize('Lab-grown vs natural diamonds — which is better for an engagement ring?', L), a: localize('Both are real diamonds with identical physical, chemical, and optical properties. Natural diamonds hold long-term resale value better, while lab-grown diamonds offer 40-60% more carat for the same budget. We help you weigh both during consultation.', L) },
      { q: localize('Do you provide GIA certification for diamonds?', L), a: localize('Yes — every natural diamond over 0.50ct ships with a GIA grading report. Lab-grown diamonds ship with IGI or GCAL reports. You can also request certification for smaller stones on request.', L) },
      { q: localize('Can I see my engagement ring before it\'s finished?', L), a: localize('Yes — we share 3D CAD renderings within 5-7 business days of your consultation, plus a wax or resin model before we cast in precious metal. You\'ll know exactly what your ring will look like before we begin final crafting.', L) },
      { q: localize('What engagement ring styles do you offer?', L), a: localize('We create Classic, Modern, Vintage, Art Deco, Halo, Solitaire, Three-Stone, and Bridal engagement rings — or any fully custom design you can envision. Unusual settings like toi et moi, cluster, and bezel-set are all within scope.', L) },
      { q: localize('Which diamond shape is best for me?', L), a: localize('Round brilliant is the most popular for its fire, oval and pear look larger per carat, princess and emerald cuts suit modern tastes, and cushion and radiant offer vintage warmth. During consultation we walk through every shape with loose stones — virtually on camera or in-person by appointment — so you can compare before choosing.', L) },
      { q: localize('Can I reset a family diamond into my new engagement ring?', L), a: localize('Yes — heirloom resets are some of our most meaningful projects. We carefully remove your existing stone and design a new setting around it, preserving the sentiment while modernizing the look.', L) },
      { q: localize('Do you offer financing for custom engagement rings?', L), a: localize('Yes — we offer flexible payment plans and 0% financing options for qualified buyers. Ask during consultation and we\'ll walk you through what fits your timeline and budget.', L) },
      { q: localize('Do you resize engagement rings for free?', L), a: localize('Yes — every custom engagement ring we create includes free resizing within the first year, and free resizing for life if you have any significant finger-size change. Free cleanings and inspections for life as well.', L) },
      { q: localize('Where are you based?', L), a: localize('Al-Asali Jewelry Studio is an Ontario-based bespoke jeweler. We work by appointment only — free virtual consultations via Zoom, phone, or message, complimentary secure insured delivery across Ontario, and optional in-person meetings at a time that works for you.', L) },
    ],
    relatedPages: [
  ...
  'rings': {
    heroH1: `Custom Rings in ${L}`,
    heroSub: localize('Signet rings, statement rings, wedding bands, and more — designed around your vision, handcrafted in Ontario.', L),
    intro: localize('From bold signet rings to elegant wedding bands and one-of-a-kind statement pieces, Al-Asali Jewelry creates custom rings that are uniquely yours. Every ring is handcrafted in-house in Ontario using the finest gold, platinum, and silver, with optional diamond and gemstone settings. Whether you have a detailed sketch or just an idea, our craftspeople will bring your ring to life with precision and care.', L),
    processNote: localize('Custom rings typically take 3-5 weeks. We begin with a design consultation, create CAD renderings, and hand-select any stones before crafting begins. Whether it\'s a wedding band, a family signet ring, or a bold everyday statement piece, we treat every ring with the same level of detail.', L),
    budgetGuide: localize('Custom rings start at $1,000 for simpler designs in 10K gold or silver, and scale with gold karat, platinum, stone settings, and design intricacy. Signet rings and wedding bands are among our most popular commissions.', L),
    stoneNote: localize('Add diamonds (natural or lab-grown), sapphires, rubies, or emeralds to any custom ring. Stones can be flush-set, prong-set, or channel-set depending on your design and daily wear needs.', L),
    faq: [
      { q: localize('What types of custom rings can you make in Ontario?', L), a: localize('Signet rings, statement rings, wedding bands, stackable rings, cocktail rings, pinky rings, mens rings, promise rings, birthstone rings, everyday essentials, and fully custom designs in any style you can imagine.', L) },
      { q: localize('How much does a custom ring cost in Ontario?', L), a: localize('Custom rings start at $1,000 in 10K gold or silver for simpler designs. Signet rings start around $1,400, statement rings $1,800, and stackable sets from $2,500 for three bands. Final price depends on metal, gold weight, stone count, and engraving.', L) },
      { q: localize('Can I bring my own design for a ring?', L), a: localize('Yes — bring sketches, reference photos, or describe your idea verbally. Our designers create detailed 3D CAD renderings for your approval before any crafting begins. Revisions are included.', L) },
      { q: localize('How do I determine my ring size?', L), a: localize('We mail you a free ring sizer, or walk you through measuring with string during your virtual consultation. If you\'d prefer, we can measure your ring size in person by appointment in Ontario. Every custom ring also includes free resizing.', L) },
      { q: localize('Can you make a custom signet ring with a family crest?', L), a: localize('Yes — family-crest signet rings are one of our favourite commissions. Send us your crest, coat of arms, monogram, or initial design and we\'ll hand-engrave it into your ring.', L) },
      { q: localize('Can I get a matching men\'s and women\'s ring set?', L), a: localize('Absolutely — matching couples rings and promise rings are a regular request. We design them in proportional sizes and complementary finishes (often different widths in matching metal).', L) },
      { q: localize('What metals are available for custom rings?', L), a: localize('10K gold, 14K gold, 18K gold in yellow, white, and rose, plus platinum and sterling silver. We\'ll recommend the right choice based on your daily wear, finger size, and budget.', L) },
      { q: localize('Do you engrave custom rings?', L), a: localize('Yes — we engrave inside or outside the band in any font, including Arabic calligraphy, dates, names, coordinates, fingerprints, and soundwaves. Engraving is free with most custom rings.', L) },
      { q: localize('Can you set diamonds or gemstones in a custom ring?', L), a: localize('Yes — natural or lab-grown diamonds, sapphires, rubies, emeralds, birthstones, and any gemstone you source. Prong, bezel, channel, pavé, flush, and tension settings all available.', L) },
      { q: localize('How long does a custom ring take in Ontario?', L), a: localize('Simpler rings take 3-4 weeks. Signet rings with engraving take 4-5 weeks. Diamond-set rings and complex designs take 5-6 weeks. Rush orders can be completed in 2-3 weeks for an additional fee.', L) },
    ],
    relatedPages: [
  ...
  'pendants': {
    heroH1: `Custom Pendants in ${L}`,
    heroSub: localize('Name pendants, photo pendants, diamond initials, and more — your story, beautifully told in gold and silver.', L),
    intro: localize('Al-Asali Jewelry creates custom pendants that carry meaning. From diamond-encrusted name pendants and photo pendants to religious symbols and fully custom designs, every piece is handcrafted in-house in Ontario. Choose your metal, your stones, and your design — we\'ll create a pendant as unique as the story it tells. Our custom name chains and bubble letter pendants are among the most requested pieces across Ontario.', L),
    processNote: localize('Custom pendants take 2-4 weeks depending on complexity. Name and initial pendants are on the faster end, while photo pendants and diamond-set pieces require additional crafting time. We create a detailed mockup for your approval before beginning work.', L),
    budgetGuide: localize('Custom pendants start at $1,000. Simple name pendants in 10K gold are the most accessible, while diamond-set photo pendants and large statement pieces sit at the higher end. We\'ll help you find the right balance of size, metal, and stone work for your budget.', L),
    stoneNote: localize('Pendants can be set with diamonds (natural or lab-grown), sapphires, rubies, or emeralds. Popular options include diamond-encrusted initials, pave-set name pendants, and bezel-set center stones.', L),
    faq: [
      { q: localize('What types of custom pendants do you make in Ontario?', L), a: localize('Name pendants, initial pendants, photo pendants, bubble letter pendants, script pendants, Old English pendants, religious symbols (Allah, Ayat al-Kursi, Bismillah, Cross, Hamsa, Om, Star of David), zodiac pendants, memorial pendants, company logos, and fully custom designs.', L) },
      { q: localize('Can you make a photo pendant?', L), a: localize('Yes — we create custom photo pendants where your image is laser-engraved onto gold or set behind a crystal dome. You can also add a diamond halo or pavé border for extra detail.', L) },
      { q: localize('How much does a custom gold pendant cost in Ontario?', L), a: localize('Custom gold pendants start around $1,000 in 10K gold, $1,500 in 14K gold, and $2,000 in 18K gold. Diamond-set pendants start from $2,500, with photo pendants from $1,800. Size, stone count, and gold weight drive final price.', L) },
      { q: localize('Do you make Arabic calligraphy pendants in Ontario?', L), a: localize('Yes — Arabic calligraphy pendants are one of our signature offerings. We craft Arabic name pendants in any font (Thuluth, Naskh, Diwani, modern script), Allah pendants, Ayat al-Kursi, Bismillah, Mashallah, and fully custom Arabic calligraphy in gold, platinum, or silver.', L) },
      { q: localize('Can you make a bubble letter pendant?', L), a: localize('Absolutely — bubble letter pendants are one of our most popular styles. Available in 10K, 14K, or 18K gold, with or without diamond pavé, in any size and name or word you want.', L) },
      { q: localize('What chain comes with a custom pendant?', L), a: localize('Chains are priced separately so you can choose the perfect pairing. We can craft a matching custom chain (cuban, rope, franco, box) in the same metal, or help you choose a stock chain from our collection.', L) },
      { q: localize('Can I add diamonds to my pendant?', L), a: localize('Yes — we set natural or lab-grown diamonds, as well as sapphires, rubies, emeralds, and birthstones. Popular options include diamond-encrusted initials, pavé-set name pendants, and bezel-set centre stones.', L) },
      { q: localize('Can you make a memorial pendant?', L), a: localize('Yes — we craft memorial pendants that incorporate fingerprints, handwriting, silhouette portraits, or small keepsakes. Cremation-ash pendants can also be arranged with advance notice.', L) },
      { q: localize('How long does a custom pendant take in Ontario?', L), a: localize('Simple name or initial pendants take 2-3 weeks. Diamond-set pendants and photo pendants take 3-4 weeks. Complex multi-stone pieces can take 4-6 weeks. Rush orders are available on request.', L) },
      { q: localize('Can you make a custom logo or company pendant?', L), a: localize('Yes — we frequently produce custom logo pendants for brands, companies, and sports teams. Send us a logo file and we\'ll translate it into a 3D CAD model for your approval before crafting.', L) },
      { q: localize('How do I receive my custom pendant?', L), a: localize('We deliver finished pieces fully insured to your door anywhere across Ontario at no extra cost, and ship securely anywhere in Canada. In-person handover by appointment is also available.', L) },
    ],
    relatedPages: [
      { name: 'Custom Chains', path: '/custom-chains' },
      { name: 'Custom Rings', path: '/custom-rings' },
  ...
  'chains': {
    heroH1: `Custom Chains in ${L}`,
    heroSub: localize('Cuban links, rope chains, franco chains, and more — built to your exact specifications in gold, silver, or platinum.', L),
    intro: localize('Al-Asali Jewelry is Ontario\'s destination for custom chains. Whether you want a heavyweight Miami Cuban link, a classic rope chain, or a sleek franco — every chain is handcrafted in-house to your exact length, width, and weight specifications. Choose from 10K, 14K, or 18K gold in yellow, white, or rose, as well as platinum and sterling silver. Our custom gold chains and name chains are among the most sought-after pieces across Ontario, built solid — never hollow.', L),
    processNote: localize('Custom chains take 2-4 weeks depending on complexity and weight. Cuban links and heavier chains require more crafting time. We weigh and measure each chain to your exact specifications before finishing.', L),
    budgetGuide: localize('Custom chain pricing depends primarily on gold weight. A lighter 10K gold box chain starts around $1,000, while a heavy 18K Cuban link can reach $10,000+. We quote based on current gold prices, karat, and your desired dimensions.', L),
    stoneNote: localize('Chains can incorporate diamond-set clasps, diamond-cut links, or integrated diamond settings. We can also create matching chain-and-pendant combinations.', L),
    faq: [
      { q: localize('What types of custom chains do you offer in Ontario?', L), a: localize('Miami Cuban link, rope, franco, figaro, box, wheat, anchor, curb, herringbone, paperclip, byzantine, and fully custom link designs. Any style, any weight, any length.', L) },
      { q: localize('How much does a custom Cuban link chain cost in Ontario?', L), a: localize('A 22" 10K gold Cuban link starts around $2,500 at 5mm width and scales with width, length, and karat. A 22" 14K Cuban at 8mm typically runs $6,000-$8,000. Solid 18K heavyweight chains at 10mm+ can reach $12,000+. We quote by exact gram weight.', L) },
      { q: localize('Solid gold vs hollow gold chains — what\'s the difference?', L), a: localize('Hollow chains are lightweight and cheaper but dent, kink, and snap under everyday wear. We only make solid gold chains — they hold their shape, last a lifetime, and hold resale value. We\'ll walk you through the weight trade-offs during consultation.', L) },
      { q: localize('How many grams is a 5mm Cuban chain?', L), a: localize('A 22" 5mm solid Cuban chain is roughly 40-50 grams in 10K gold, 45-55 grams in 14K, and 50-60 grams in 18K. Exact weight varies slightly by link style. We weigh and measure to your spec before finishing.', L) },
      { q: localize('What gold karats are available for chains?', L), a: localize('10K, 14K, and 18K gold in yellow, white, and rose, plus platinum and sterling silver. 14K is our most popular — a great balance of colour, durability, and price for everyday wear.', L) },
      { q: localize('Can I customize the length and width of my chain?', L), a: localize('Yes — every chain is made to your exact length, width, and gram weight specifications. Common lengths: 18", 20", 22", 24", 26", 28", 30". Widths from 2mm to 15mm+ depending on chain style.', L) },
      { q: localize('Do you make chains with name plates or pendants integrated?', L), a: localize('Yes — we can integrate custom name plates, ID bars, pendants, and diamond-set sections into any chain design. Matching chain-and-pendant sets are a signature offering.', L) },
      { q: localize('Can you add diamonds to a chain clasp or links?', L), a: localize('Yes — diamond-set clasps, diamond-cut facets, and fully diamond-embedded links (iced-out chains) are all available. Natural or lab-grown, any clarity tier.', L) },
      { q: localize('How long does a custom chain take in Ontario?', L), a: localize('Most chains take 2-4 weeks. Lightweight chains 2-3 weeks, heavyweight Cuban or franco chains 3-4 weeks, fully iced-out chains 5-6 weeks due to setting work. Rush production is available.', L) },
      { q: localize('Do you repair or re-solder broken chains?', L), a: localize('Yes — we repair, re-solder, and re-plate chains (even if they weren\'t made here). We also shorten and extend existing chains to your preferred length.', L) },
    ],
    relatedPages: [
      { name: 'Custom Pendants', path: '/custom-pendants' },
      { name: 'Custom Bracelets', path: '/custom-bracelets' },
  ...
  'earrings': {
    heroH1: `Custom Earrings in ${L}`,
    heroSub: localize('Diamond studs, gold hoops, drop earrings, and more — handcrafted to your design in our Ontario studio.', L),
    intro: localize('From elegant diamond studs to bold statement hoops, Al-Asali Jewelry designs and crafts custom earrings entirely in-house in Ontario. Choose your style, your metal, and your stones — whether you want a subtle everyday pair or a show-stopping set for a special occasion, we craft them to perfection. We also create matching earring-and-pendant sets for a cohesive look.', L),
    processNote: localize('Custom earrings take 2-4 weeks. Stud earrings are quicker to produce, while complex chandelier designs with multiple stone settings require more time. We create a detailed design for your approval before crafting.', L),
    budgetGuide: localize('Custom earrings start at $1,000. Diamond stud earrings are priced based on stone size and quality, while gold hoops depend on weight and karat. We\'ll find the best combination for your budget.', L),
    stoneNote: localize('Earrings can feature diamonds (natural or lab-grown), sapphires, rubies, and emeralds. Popular choices include diamond stud earrings, pave-set hoops, and drop earrings with colored gemstones.', L),
    faq: [
      { q: localize('What types of custom earrings can you make in Ontario?', L), a: localize('Diamond studs, gold hoops, huggies, drop earrings, chandelier earrings, ear climbers, ear cuffs, threader earrings, cluster earrings, and fully custom designs — all handcrafted in our Ontario studio.', L) },
      { q: localize('How much do custom diamond stud earrings cost in Ontario?', L), a: localize('0.5ctw lab-grown studs start around $1,000 in 14K gold. 1ctw studs $1,500-$2,500 (lab) or $3,500-$5,000 (natural). 2ctw studs $3,000-$6,000 (lab) or $8,000-$15,000 (natural). Premium VVS clarity adds 15-25% to each tier.', L) },
      { q: localize('Lab-grown vs natural diamond studs — which should I choose?', L), a: localize('Lab-grown studs deliver the same brilliance and hardness for roughly 50% less — ideal if you want bigger visible size. Natural diamonds hold long-term resale value and carry heirloom sentiment. Both are real diamonds; we\'ll show you loose stones of each to compare.', L) },
      { q: localize('How much do custom gold hoops cost?', L), a: localize('Plain 10K gold hoops start around $800, 14K from $1,100, 18K from $1,500. Diamond-set pavé hoops start from $2,500. Final price scales with diameter, width, and gold weight.', L) },
      { q: localize('Can I design matching earrings, pendant, and ring?', L), a: localize('Yes — matching sets are a signature offering. Design your earrings alongside a pendant, ring, or bracelet for a cohesive collection. We offer set discounts when ordered together.', L) },
      { q: localize('Do you make huggies and small everyday earrings?', L), a: localize('Yes — huggies, small hoops, and everyday studs are some of our most popular pieces. We make them in 10K, 14K, or 18K gold with optional diamond pavé.', L) },
      { q: localize('What metals are available for earrings?', L), a: localize('10K, 14K, and 18K gold in yellow, white, and rose, plus platinum and sterling silver. Platinum is the most durable and hypoallergenic — ideal if you have sensitive ears.', L) },
      { q: localize('What\'s the difference between push-back and screw-back studs?', L), a: localize('Push-back (friction-back) is the standard — easy to wear daily. Screw-back is more secure for high-value diamonds you never want to lose. We offer both and will recommend based on stone size and how you\'ll wear them.', L) },
      { q: localize('How long do custom earrings take in Ontario?', L), a: localize('Diamond studs take 2-3 weeks, plain gold hoops 2-3 weeks, pavé hoops 3-4 weeks, chandelier and complex multi-stone designs 4-5 weeks. Rush production available.', L) },
      { q: localize('Can I get earrings re-plated or diamonds tightened?', L), a: localize('Yes — free rhodium re-plating and free diamond tightening for life on every pair we create. We also service earrings from other jewelers at competitive rates.', L) },
    ],
    relatedPages: [
      { name: 'Custom Pendants', path: '/custom-pendants' },
      { name: 'Custom Rings', path: '/custom-rings' },
  ...
  'bracelets': {
    heroH1: `Custom Bracelets in ${L}`,
    heroSub: localize('Tennis bracelets, bangles, cuffs, and engraved pieces for men and women — designed and crafted in Ontario.', L),
    intro: localize('Al-Asali Jewelry creates custom bracelets for every style and occasion. From diamond tennis bracelets and elegant bangles to bold cuffs and engraved pieces for men, every bracelet is handcrafted in-house in Ontario. Whether you want a personalized name bracelet, a custom charm bracelet, or a mens engraved bracelet in solid gold — we\'ll create a piece that fits your wrist and your vision perfectly.', L),
    processNote: localize('Custom bracelets take 3-5 weeks. Tennis bracelets with many individual stone settings require more time, while bangles and cuffs are quicker. We measure your wrist for a precise fit during consultation.', L),
    budgetGuide: localize('Custom bracelets start at $1,000. Tennis bracelets are priced based on stone count and quality, while bangles and cuffs depend on metal weight. Engraved bracelets for men are among our most popular commissions.', L),
    stoneNote: localize('Bracelets can feature diamonds, sapphires, and other gemstones. Tennis bracelets with round brilliant diamonds are our most popular stone-set bracelet style. We also offer diamond-accented cuffs and charm bracelets.', L),
    faq: [
      { q: localize('What types of custom bracelets do you make in Ontario?', L), a: localize('Tennis bracelets, chain bracelets (Cuban, rope, franco, figaro), bangles, cuffs, charm bracelets, ID bracelets, engraved mens bracelets, byzantine bracelets, and fully custom designs for men and women.', L) },
      { q: localize('How much does a custom tennis bracelet cost in Ontario?', L), a: localize('Lab-grown diamond tennis bracelets: 2ctw from $2,500, 3ctw from $3,800, 5ctw from $6,500, 7ctw from $9,500, 10ctw from $14,000. Natural diamond tennis bracelets typically cost 2.5-3x the lab-grown equivalent. All prices in 14K gold.', L) },
      { q: localize('Can I get an engraved bracelet for men in Ontario?', L), a: localize('Yes — engraved men\'s bracelets are one of our most requested pieces. ID bracelets, Cuban link with name plate, Figaro with engraved bar, or solid cuffs — all with custom engraving in any font including Arabic calligraphy, dates, names, or logos.', L) },
      { q: localize('How do I measure my wrist for a bracelet?', L), a: localize('Wrap a flexible tape measure snugly around your wrist just below the wrist bone, then add 0.5" (loose) or 0.25" (snug). Standard men\'s: 7.5-8.5". Standard women\'s: 6.5-7". We\'re happy to walk you through it on Zoom, or measure your wrist in person by appointment in Ontario.', L) },
      { q: localize('What\'s the difference between a tennis bracelet and a diamond chain bracelet?', L), a: localize('A tennis bracelet has prong-set diamonds in a continuous line, each stone visible front and side. A diamond chain bracelet has stones set into chain links. Tennis bracelets typically show more stone face-up and are the more formal style.', L) },
      { q: localize('Do you make custom ID bracelets?', L), a: localize('Yes — ID bracelets are a staple of our mens collection. Solid gold, platinum, or silver plates engraved with names, dates, Arabic calligraphy, or any custom design. Attached to Cuban, figaro, or rope link chains.', L) },
      { q: localize('Can I add diamonds to a bangle or cuff?', L), a: localize('Yes — pavé-set bangles, diamond-accent cuffs, and fully diamond-encrusted cuffs are all available. Natural or lab-grown, any clarity tier.', L) },
      { q: localize('What metals are available for custom bracelets?', L), a: localize('10K, 14K, and 18K gold in yellow, white, and rose, plus platinum and sterling silver. 14K and 18K are our most popular for bracelets due to everyday durability.', L) },
      { q: localize('Do you offer safety chains on tennis bracelets?', L), a: localize('Yes — every tennis bracelet we make includes a safety chain and a double-lock box clasp as standard. Lost a stone from an older bracelet? We can repair and add safety chains to bracelets made elsewhere.', L) },
      { q: localize('How long does a custom bracelet take in Ontario?', L), a: localize('Tennis bracelets 4-5 weeks due to hand-setting each stone. Bangles and cuffs 3-4 weeks. Chain bracelets 2-3 weeks. Engraved ID bracelets 3-4 weeks. Rush production available.', L) },
    ],
    relatedPages: [
      { name: 'Custom Chains', path: '/custom-chains' },
      { name: 'Custom Rings', path: '/custom-rings' },
  ...
  'grillz': {
    heroH1: `Custom Grillz in ${L}`,
    heroSub: localize('Gold grillz, diamond grillz, and VVS sets — Ontario\'s premier custom grillz studio. In-house craftsmanship, competitive prices.', L),
    intro: localize('Al-Asali Jewelry is Ontario\'s go-to destination for custom grillz. From single-tooth pieces to full diamond-set grillz, every set is handcrafted in-house using real gold and genuine diamonds — not plated, not CZ. We offer 10K, 14K, and 18K gold in yellow, white, and rose, with optional VVS diamond, diamond dust, and fully custom designs. Our mold process ensures a perfect fit every time, and our prices are explained upfront with no surprises. Whether you\'re looking for gold grillz, diamond grillz, or something entirely unique, we\'re the only shop in Ontario that does it all under one roof.', L),
    processNote: localize('Custom grillz take 1-2 weeks after your mold appointment. We take a precise dental impression, design your grillz, and handcraft them in your chosen metal and stone configuration. Mold sessions are booked by appointment in Ontario.', L),
    budgetGuide: localize('Grillz start at $500 for a single tooth in 10K gold. Top 6 or bottom 6 sets range from $2,000-$5,000 in solid gold. Full diamond-set VVS grillz start around $5,000 and scale with diamond quality and coverage.', L),
    stoneNote: localize('We set genuine natural and lab-grown diamonds in grillz, including VVS clarity stones. Diamond dust finishes, channel-set diamonds, and fully iced-out options are all available. No cubic zirconia — ever.', L),
    faq: [
      { q: localize('How much do custom grillz cost in Ontario?', L), a: localize('Single tooth grillz start at $500 in 10K gold. Top 6 or bottom 6 sets range from $2,000-$5,000 in solid gold. Full diamond-set VVS grillz start around $5,000 and scale to $15,000+ for fully iced-out sets. Every quote is broken down up front by gold weight, karat, and stone count.', L) },
      { q: localize('What types of grillz do you offer?', L), a: localize('Full sets (top + bottom), top 6, bottom 6, top 8, bottom 8, single tooth, fangs, open-face, honeycomb, bar, diamond dust, and fully custom designs. We also create matching grillz for couples and teams.', L) },
      { q: localize('Are your grillz removable?', L), a: localize('Yes — every grillz we make is removable. We create a precise dental mold of your teeth for a snug, secure fit that clicks in and out without permanently altering your teeth.', L) },
      { q: localize('Are removable grillz safe for your teeth?', L), a: localize('Yes, when properly made. Because our grillz are custom-fit from your exact dental mold, they sit snugly without damaging enamel. We recommend removing them before eating and cleaning them with a soft brush daily.', L) },
      { q: localize('VVS vs VS vs SI — which clarity should I pick for grillz?', L), a: localize('VVS offers the cleanest, brightest look and is our premium tier. VS gives a near-identical visual face-up for about 20-30% less. SI stones look great in micro-pavé or dust settings. We\'ll walk through all three with loose stones during consultation.', L) },
      { q: localize('Do you use real diamonds in grillz?', L), a: localize('Yes — genuine natural and lab-grown diamonds only, including VVS clarity stones. No cubic zirconia, no moissanite substitutions, ever. Every stone is hand-set by our master jeweler in Ontario.', L) },
      { q: localize('What gold karats are available for grillz?', L), a: localize('10K, 14K, and 18K gold in yellow, white, and rose gold. 10K is the most durable and affordable. 14K is our most popular — a great balance of colour and price. 18K delivers the deepest yellow but is softer and needs gentler care.', L) },
      { q: localize('How long does it take to make custom grillz in Ontario?', L), a: localize('Most custom grillz are completed in 1-2 weeks after your mold appointment. Full diamond-set VVS sets can take 3-4 weeks due to the setting work. Rush orders are available on request.', L) },
      { q: localize('How does the grillz mold process work?', L), a: localize('We take a precise dental-grade silicone impression of your teeth at a by-appointment mold session in Ontario. The impression is cast into a stone model that we use to shape and fit your grillz exactly to your bite. The appointment takes about 20 minutes.', L) },
      { q: localize('Can I eat or drink with grillz in?', L), a: localize('We recommend removing grillz before eating to protect both the grillz and your teeth. Drinking water is fine. Avoid sugary drinks with grillz in to prevent buildup along the gum line.', L) },
      { q: localize('Do you offer permanent grillz?', L), a: localize('We specialize in removable custom grillz because they\'re safer for your long-term oral health. If you\'re looking for semi-permanent grillz, we\'ll discuss the pros, cons, and dental considerations during consultation.', L) },
      { q: localize('Do you make matching grillz for couples?', L), a: localize('Yes — matching couples grillz are one of our most requested orders. We can create mirrored designs, shared stones, or complementary styles between partners.', L) },
    ],
    relatedPages: [
      { name: 'Custom Chains', path: '/custom-chains' },
      { name: 'Custom Pendants', path: '/custom-pendants' },
  ...
  'wedding-bands': {
    heroH1: `Custom Wedding Bands in ${L}`,
    heroSub: localize('Bands as timeless as your vow — handcrafted in Ontario to match your ring, your finish, and your story.', L),
    intro: localize('A wedding band is the piece you\'ll wear every single day for the rest of your life, so it deserves the same care as the engagement ring it sits beside. At Al-Asali Jewelry, every custom wedding band is designed and handcrafted in-house in Ontario — from classic comfort-fit bands and eternity rings to contour-shaped bands that nest perfectly against a halo or solitaire. Choose platinum, 18K, 14K, or 10K gold in yellow, white, or rose, with optional diamond or gemstone accents and any engraving you can imagine, including Arabic calligraphy, fingerprints, and soundwaves. We craft matching bridal sets for couples, modern men\'s bands in brushed or hammered finishes, and stackable anniversary bands — all with our lifetime craftsmanship guarantee.', L),
    processNote: localize('Custom wedding bands take 3-5 weeks from design approval to completion. We start with a free consultation to understand the fit, finish, and story you want, create CAD renderings for your approval, then hand-craft each band in your chosen metal. Matching bridal sets are designed alongside the engagement ring when possible to ensure a perfect nest. Rush orders can be completed in 2-3 weeks for an additional fee.', L),
    budgetGuide: localize('Custom wedding bands start at $900 for plain 10K gold bands and scale with karat, width, eternity stone coverage, and engraving complexity. A solid platinum comfort-fit band typically starts around $1,800, a half-eternity diamond band around $3,500, and a full diamond eternity band from $6,000. We quote every band up front with no hidden fees.', L),
    stoneNote: localize('Bands can be set with diamonds (natural or lab-grown), sapphires, rubies, or emeralds in channel, bead, or shared-prong settings. Eternity and half-eternity bands are our most popular stone-set options, with birthstone bands a close second for anniversary pieces.', L),
    faq: [
      { q: localize('How much does a custom wedding band cost in Ontario?', L), a: localize('Custom wedding bands start at $900 for plain 10K gold and scale with metal karat, width, diamond coverage, and engraving. Platinum bands start around $1,800, half-eternity diamond bands from $3,500.', L) },
      { q: localize('Do you match wedding bands to engagement rings?', L), a: localize('Yes — we specialize in contour and shaped bands that nest flush against halo, solitaire, and three-stone engagement rings. Bring in your engagement ring and we\'ll design a band to match.', L) },
      { q: localize('What\'s the difference between comfort fit and standard fit?', L), a: localize('Comfort-fit bands have a slightly domed interior, making them easier to slide over the knuckle and more comfortable for daily wear. Standard-fit bands have a flat interior and feel slightly more traditional.', L) },
      { q: localize('Can you engrave Arabic calligraphy on a wedding band?', L), a: localize('Absolutely — we engrave Arabic calligraphy, scripture, names, dates, fingerprints, soundwaves, and any custom design you envision, inside or outside the band.', L) },
      { q: localize('Do you make men\'s wedding bands?', L), a: localize('Yes — we craft men\'s wedding bands in widths from 4mm to 10mm with brushed, hammered, polished, or matte finishes. Popular options include tungsten-look platinum, two-tone gold, and diamond-accent bands.', L) },
      { q: localize('How long does a custom wedding band take in Ontario?', L), a: localize('Most bands take 3-5 weeks from design approval. Matching bridal sets take 4-6 weeks. Rush orders can be completed in 2-3 weeks for an additional fee.', L) },
      { q: localize('Can I reset diamonds from a family ring into a new band?', L), a: localize('Yes — heirloom resets are one of our most meaningful projects. We\'ll carefully remove the stones and reset them into your new custom band design.', L) },
      { q: localize('Do you make stackable anniversary bands?', L), a: localize('Yes — we love designing stackable sets that add a new band for every anniversary or milestone. Mix metals, karats, and stone colours for a truly personal stack.', L) },
      { q: localize('Can you size my band precisely?', L), a: localize('Yes — we measure your ring size during consultation at no charge, and every custom band includes free resizing for life if your size changes.', L) },
    ],
    relatedPages: [
      { name: 'Custom Engagement Rings', path: '/custom-engagement-rings' },
      { name: 'Custom Rings', path: '/custom-rings' },
...
function LandingPage({ type, city }: { type: string; city?: CityProp }) {
  const config = typeConfig[type]
  if (!config) return null

  const locationName = city?.name || 'Ontario'
  const landingContentMap = getLandingContent(locationName)
  const landing = landingContentMap[type]
  ...
  // Location-aware "Why Choose" cards
  const whyCards: { icon: LucideIcon; title: string; text: string }[] = [
    { icon: MapPin, title: `Made in ${locationName}`, text: localize('Every piece crafted entirely in-house in Ontario — no outsourcing, no middlemen.', locationName) },
  ...
  // Location-aware trust text
  const trustText = localize('Proudly crafted in Ontario, serving communities across Ontario', locationName)
  ...
  // Breadcrumb: for city pages, include city level
  const breadcrumbItems = city
    ? [
        { name: 'Home', url: SITE_CONFIG.url },
        { name: city.name, url: `${SITE_CONFIG.url}/${city.slug}` },
        { name: config.title, url: `${SITE_CONFIG.url}/${city.slug}/custom-${type}` },
      ]
    : [
        { name: 'Home', url: SITE_CONFIG.url },
        ...
        <section className="py-12 px-4 border-t border-glacier-grey/10">
          <div className="max-w-2xl mx-auto text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <span className="text-stone text-sm">{trustText}</span>
            </div>
...
function getHubFaq(locationName: string) {
  return [
    { q: 'Where is Al-Asali Jewelry based?', a: localize('Al-Asali Jewelry Studio is an Ontario-based bespoke jeweler. We operate by appointment only — virtual consultations, secure insured delivery across Ontario, and optional in-person meetings when preferred.', locationName) },
    { q: localize('Do I need an appointment to visit the Ontario studio?', locationName), a: localize('Yes — we work by appointment only. Book a free consultation by phone, email, or through our custom inquiry form and we\'ll confirm a time that works for you.', locationName) },
    { q: localize('What areas in Ontario do you serve?', locationName), a: localize('Our studio is in Ontario, and we regularly work with clients from communities across Ontario including Toronto, Mississauga, Etobicoke, North York, Scarborough, Vaughan, Markham, Oakville, Burlington, Brampton, and Milton.', locationName) },
    { q: 'How do I start a custom jewelry project?', a: localize('Book a free consultation — virtual via Zoom, phone, or message, or in-person by appointment. We\'ll discuss your vision, budget, and timeline, then produce CAD renderings for your approval before any crafting begins. Most projects take 2-6 weeks from design approval.', locationName) },
    { q: localize('How much does custom jewelry cost in Ontario?', locationName), a: localize('Most of our custom pieces start between $500 (single-tooth grillz) and $1,000 (custom rings, pendants, earrings, bracelets, chains), scaling with metal, stones, and design complexity. We quote every project up front with no hidden fees.', locationName) },
    ...
    { q: localize('Do you ship across Ontario?', locationName), a: localize('Yes — we ship securely across Ontario and anywhere in Canada. Finished pieces are always fully insured in transit.', locationName) },
  ]
}

function GeneralHub({ city }: { city?: CityProp }) {
  const locationName = city?.name || 'Ontario'
  const hubFaq = getHubFaq(locationName)
  ...
  // Location-aware contact info
  const phone = city?.phone || '(647) 562-4340'
  const phoneHref = `tel:${phone.replace(/[^0-9+]/g, '')}`

  // Location-aware neighborhood list
  const neighborhoodText = city?.neighborhoods
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-20 md:py-28 space-y-20">
        ...
        <header className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 mb-5">
            ...
            <span className="text-xs uppercase tracking-widest text-glacier-grey font-medium">{locationName}&apos;s Custom Jewelry Studio</span>
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-5" style={{ fontFamily: 'var(--font-heading)' }}>
            {locationName}&apos;s Premier Custom Jeweler
          </h2>
          <p className="text-stone leading-relaxed text-base md:text-lg">
            {localize('Al-Asali Jewelry is an Ontario-based bespoke jewelry studio, working by appointment. Master jeweler Mohammad Al-Asali and our team design and handcraft every custom engagement ring, wedding band, diamond pendant, gold chain, and grillz set entirely in-house — no outsourcing, no middlemen. From the first consultation to the final polish, every piece is crafted under one roof with a lifetime craftsmanship guarantee.', locationName)}
          </p>
        </header>
        ...
        <div className="bg-charcoal/40 border border-glacier-grey/20 rounded-2xl p-8 md:p-12">
          ...
          <p className="text-stone text-center mb-10 max-w-2xl mx-auto text-sm">
            {localize('We are a small, focused Ontario workshop. Every piece is crafted by a master jeweler — not a factory — and backed by a lifetime craftsmanship guarantee.', locationName)}
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: MapPin, title: `Made in ${locationName}`, body: localize('Designed, cast, set, and finished entirely in-house in our Ontario studio.', locationName) },
              ...
              { icon: Star, title: '5.0 on Google', body: localize('5-star rated by clients across Ontario.', locationName) },
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <p className="text-stone leading-relaxed text-sm mb-6">
            {localize('Al-Asali Jewelry Studio is an Ontario-based bespoke jeweler, serving clients across Ontario by appointment. Free virtual consultations via Zoom, phone, or message, complimentary secure insured delivery of finished pieces — and in-person meetings whenever you prefer.', locationName)}
          </p>
          {city?.address && (
            <p className="text-stone text-sm mb-4">
              <MapPin className="w-4 h-4 text-glacier-grey inline mr-1" />
              {city.address}
            </p>
          )}
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <a href={phoneHref} className="inline-flex items-center gap-2 text-glacier-grey hover:text-glacier-grey-light">
...
// ---------------------------------------------------------------------------
// PortalForm (only for /custom/general — Start Your Journey)
// ---------------------------------------------------------------------------
...
export function ServicePageContent({ type, city }: { type: string; city?: CityProp }) {
  // Specific type → landing page (no form)
  if (type !== 'general' && type in typeConfig) {
    return <LandingPage type={type} city={city} />
  }

  // /custom/general → form + hub SEO content
  return (
    <Suspense fallback={null}>
      <PortalForm />
      <GeneralHub city={city} />
    </Suspense>
  )
}
